...
class MyPlane(pygame.sprite.Sprite):
    def __init__(self, bg_size):
        ...
        self.rect.left, self.rect.top = ((bg_size.width-self.rect.width) / 2,bg_size.height-self.rect.height - 50)
        # 状态
        self.alive = True
        # 速度
        self.speed = 10
    ...
    def reset(self):
        self.alive =True
        self.rect.left, self.rect.top = ((self.bg_size.width - self.rect.width) / 2, self.bg_size.height - self.rect.height - 50)
