...
class BigEnemy(pygame.sprite.Sprite):
    ...
    def reset(self):
        ...
        self.energy = BigEnemy.energy
#炸弹
class Zhadan(pygame.sprite.Sprite):
    def __init__(self, bg_size):
        pygame.sprite.Sprite.__init__(self)
        # 小敌机图片--->Surface
        self.image1 = pygame.image.load("./images/bomb_supply.png")
        self.rect = self.image1.get_rect()
        # 背景的宽度, 高度
        self.width = bg_size.width
        self.height = bg_size.height
    ...
    def reset(self):
        ...
        self.energy = BigEnemy.energy
#火力加强
class Zhidan(pygame.sprite.Sprite):
    def __init__(self, bg_size):
        pygame.sprite.Sprite.__init__(self)
        # 小敌机图片--->Surface
        self.image1 = pygame.image.load("./images/bullet_supply.png")
        self.rect = self.image1.get_rect()
        # 背景的宽度, 高度
        self.width = bg_size.width
        self.height = bg_size.height
